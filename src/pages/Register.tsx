        ...
        <div className="w-full max-w-md mx-auto -mt-20">
            ...
            >
                ...
                <div className="text-center mb-8 relative z-10">
                    ...
                    <p className="text-on-surface-variant text-sm">Join ShortenIt for advanced link tracking.</p>
                </div>
                ...
                {success ? (
                    <div className="relative z-10 text-center space-y-4 py-8">
                        <div className="w-16 h-16 bg-tertiary-fixed flex items-center justify-center rounded-full mx-auto text-tertiary-container shadow-sm">
                            <span className="material-symbols-outlined text-3xl">check</span>
                        </div>
                        <h3 className="text-xl font-bold text-on-surface">Registration Success!</h3>
                        <p className="text-on-surface-variant text-sm px-4">Please check your email to confirm your account and log in.</p>
                    </div>
                ) : (
                    <form className="space-y-4 relative z-10" onSubmit={handleRegister}>
                        ...
                        <div>
                            <label className="block text-sm font-bold text-on-surface mb-1.5 ml-1">Full Name</label>
                            <input 
                                type="text" 
                                required
                                value={name}
